...
import fm.jiecao.jcvideoplayer_lib.broadcast.NetDataUtil;
import fm.jiecao.jcvideoplayer_lib.broadcast.NetWorkReceiver;
import fm.jiecao.jcvideoplayer_lib.broadcast.NetWorkReceiverCallback;
...
//    };
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            onEvent(JCUserAction.ON_TOUCH_BACK_BEFOR);
            backPress();
            onEvent(JCUserAction.ON_TOUCH_BACK_LAST);
