...
public class JCUtils {
    ...
    public static void setRequestedOrientation(Context context, int orientation) {
        if (JCUtils.getAppCompActivity(context) != null) {
            JCUtils.getAppCompActivity(context).setRequestedOrientation(
                    orientation);
        } else {
            JCUtils.scanForActivity(context).setRequestedOrientation(
                    orientation);
        }
    }
    ////////////////////////
    public static Window getWindow(Context context) {
        if (JCUtils.getAppCompActivity(context) != null) {
            return JCUtils.getAppCompActivity(context).getWindow();
        } else {
            return JCUtils.scanForActivity(context).getWindow();
        }
    }
